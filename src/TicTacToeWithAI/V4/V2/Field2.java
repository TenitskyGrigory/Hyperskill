            ...
            while (!move) {
                for (int i = 0; i < 3; i++) {
                    if (field[0][i] == 'X' && field[1][i] == 'X' && field[2][i] == ' ') {
                        ...
                        move = true;
                        break;
                    } else if (field[0][i] == 'O' && field[1][i] == 'O' && field[2][i] == ' ') {
                        field[2][i] = 'X';
                        move = true;
                        break;
...
//                            move = true;
            ...
            if (field[0][i] == 'O' && field[2][i] == 'O' && field[1][i] == ' ') {
                field[1][i] = 'O';
//                            move = true;
                break;
            }
            if (field[1][i] == 'O' && field[2][i] == 'O' && field[0][i] == ' ') {
                field[0][i] = 'O';
//                            move = true;
                break;
            }
...
//                            move = true;
            ...
            if (field[i][0] == 'O' && field[i][2] == 'O' && field[i][1] == ' ') {
                field[i][1] = 'O';
//                            move = true;
                break;
            }
            if (field[i][1] == 'O' && field[i][2] == 'O' && field[i][0] == ' ') {
                field[i][0] = 'O';
//                            move = true;
                break;
            }
...
//                            move = true;
            ...
            if (field[0][0] == 'O' && field[2][2] == 'O' && field[1][1] == ' ') {
                field[1][1] = 'O';
//                            move = true;
                break;
            }
            if (field[1][1] == 'O' && field[2][2] == 'O' && field[0][0] == ' ') {
                field[0][0] = 'O';
//                            move = true;
                break;
            }

            if (field[0][2] == 'O' && field[1][1] == 'O' && field[2][0] == ' ') {
                field[2][0] = 'O';
//                            move = true;
                break;
            }
            if (field[0][2] == 'O' && field[2][0] == 'O' && field[1][1] == ' ') {
                field[1][1] = 'O';
//                            move = true;
                break;
            }
            if (field[1][1] == 'O' && field[2][0] == 'O' && field[0][2] == ' ') {
                field[0][2] = 'O';
//                            move = true;
                break;
            }
...
//                            move = true;
            ...
            if (field[0][i] == 'X' && field[2][i] == 'X' && field[1][i] == ' ') {
                field[1][i] = 'O';
//                            move = true;
                break;
            }
            if (field[1][i] == 'X' && field[2][i] == 'X' && field[0][i] == ' ') {
                field[0][i] = 'O';
//                            move = true;
                break;
            }
...
//                            move = true;
            ...
            if (field[i][0] == 'X' && field[i][2] == 'X' && field[i][1] == ' ') {
                field[i][1] = 'O';
//                            move = true;
                break;
            }
            if (field[i][1] == 'X' && field[i][2] == 'X' && field[i][0] == ' ') {
                field[i][0] = 'O';
//                            move = true;
                break;
            }
...
//                            move = true;
            ...
            if (field[0][0] == 'X' && field[2][2] == 'X' && field[1][1] == ' ') {
                field[1][1] = 'O';
//                            move = true;
                break;
            }
            if (field[1][1] == 'X' && field[2][2] == 'X' && field[0][0] == ' ') {
                field[0][0] = 'O';
//                            move = true;
                break;
            }

            if (field[0][2] == 'X' && field[1][1] == 'X' && field[2][0] == ' ') {
                field[2][0] = 'O';
//                            move = true;
                break;
            }
            if (field[0][2] == 'X' && field[2][0] == 'X' && field[1][1] == ' ') {
                field[1][1] = 'O';
//                            move = true;
                break;
            }
            if (field[1][1] == 'X' && field[2][0] == 'X' && field[0][2] == ' ') {
                field[0][2] = 'O';
//                            move = true;
                break;
            }
